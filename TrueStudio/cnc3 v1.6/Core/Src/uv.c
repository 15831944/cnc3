...
static double L; // distance between top and bottom rollers, mm
static double H; // height from bottom roller to workpiece bottom (XY), mm
static double T; // workpiece thickness, mm
static BOOL valid;
