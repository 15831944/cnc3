/****************************************************************************
** Meta object code from reading C++ file 'center_widget.h'
**
...
#include <memory>
#include "../../ICNC/center_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'center_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 26, 10), // "CenterMode"
QT_MOC_LITERAL(4, 37, 4) // "mode"

    },
    "CenterWidget\0modeChanged\0\0CenterMode\0"
    "mode"
};
...
void CenterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CenterWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modeChanged((*reinterpret_cast< CenterMode(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CenterWidget::*)(CenterMode );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CenterWidget::modeChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CenterWidget::modeChanged(CenterMode _t1)
{
