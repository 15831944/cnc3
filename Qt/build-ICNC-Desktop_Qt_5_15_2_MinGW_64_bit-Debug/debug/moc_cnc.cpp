...
struct qt_meta_stringdata_Cnc_t {
    QByteArrayData data[1];
    char stringdata0[4];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Cnc_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Cnc_t qt_meta_stringdata_Cnc = {
    {
QT_MOC_LITERAL(0, 0, 3) // "Cnc"
...
QT_INIT_METAOBJECT const QMetaObject Cnc::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Cnc.data,
    qt_meta_data_Cnc,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Cnc::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cnc.stringdata0))
