...
public:
    ...
    QLabel *labelRadius, *labelFinePct, *labelRollback, *labelCoarseSpeed, *labelFineSpeed, *labelDrumVel, *labelThreshold, *labelHighThld, *labelTouches, *labelAttempts,\
    *labelX, *labelY, *labelVolt, *labelSpeed;
    ...
    QSpinBox *numFinePct, *numDrumVel;
