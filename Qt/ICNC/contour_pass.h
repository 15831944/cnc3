...
class ContourPass {
    ...
    static std::deque<ContourPair> join(std::deque<ContourPair>& pass, std::deque<ContourPair>& tab, std::deque<ContourPair>& overlap);
    static void join(std::deque<ContourPair>& contours, ContourPair& out);
    static std::deque<ContourPair> join(std::deque<ContourPair>& pass, std::deque<ContourPair>& tab, std::deque<ContourPair>& overlap, ContourPair& out);
    static std::deque<ContourPair> joinLoop(std::deque<ContourPair>& pass, std::deque<ContourPair>& tab, std::deque<ContourPair>& overlap);
    ...
    static void printDebug(const std::deque<ContourPair>& pass, const std::deque<ContourPair>& tab, const std::deque<ContourPair>& overlap, const ContourPair& out);
