...
std::string FpgaBus::readVersion() {
    ...
    std::string res = QObject::tr("FPGA").toStdString() + ": " + fpga_s;
    qDebug("%s", res.c_str());
    return res;
}
