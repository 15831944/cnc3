...
public:
    ...
    QString fileDir; // current file directory
    QString gcodeFileName, contourFileName, modesFileName, cutFileName; // data files
    AppState appState;
    ...
    ContourList workContours; // work multipass contour for cutting
    ...
    static void saveFeedbackParam(bool fb_ena, double low_thld, double high_thld, double rb_to, unsigned rb_attempts, double rb_len, double rb_speed);
