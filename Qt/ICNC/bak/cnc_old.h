...
private:
    static constexpr double COE_UMSEC2_TO_MMTICK2 = 1e-3 / (FpgaBus::CLOCK * FpgaBus::CLOCK);

    std::deque<MotorRecord> imit_list;
    aux_func::Reporter msg;
