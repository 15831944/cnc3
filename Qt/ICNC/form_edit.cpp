...
void FormEdit::createButtons() {
    ...
    btnOpen->setStatusTip(tr("Open G-code file"));

    btnSave = new QPushButton(tr("Save"));
    btnSave->setStatusTip(tr("Save G-code file"));
    ...
    btnPlot->setStatusTip(tr("Show the plot"));
...
//    btnPlay = new QPushButton(tr("Play"));
    ...
    btnContour->setStatusTip(tr("Convert G-code file into a contour"));
...
void FormEdit::on_btnOpen_clicked() {
    ...
    if (openGcodeFileDialog(file, par.fileDir, par.gcodeFileName)) {
