...
class UVSizingWidget : public QWidget {
    ...
    QLabel *labelMeasuring, *labelRecalc, *labelResult, *labelWireD, *labelUMax, *labelL, *labelH, *labelT, *labelLine, *labelDTop, *labelDBot, *labelResL, *labelResH;
    QDoubleSpinBox *fnumWireD, *fnumUMax, *fnumL, *fnumH, *fnumT, *fnumLine, *fnumDTop, *fnumDBot, *fnumResL, *fnumResH;
    QRadioButton *radioXp, *radioXn, *radioYp, *radioYn;
    QGroupBox *groupMeasuring, *groupRecalc, *groupResult, *groupAxis;
