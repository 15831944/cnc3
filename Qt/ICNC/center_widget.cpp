...
//    qwtPlot->setCanvasBackground( Qt::white );
    ...
    groupMode = new QGroupBox(tr("Center Mode"));
    radioMode1R = new QRadioButton(tr("Line"));
    radioMode4R = new QRadioButton(tr("4 points (right angles)"));
    radioMode3Adj = new QRadioButton(tr("3 points (adjustable angles)"));
    ...
    gridControl->addWidget(labelDrumVel, 6, 0, Qt::AlignRight);
    gridControl->addWidget(numDrumVel, 6, 1, Qt::AlignLeft);
